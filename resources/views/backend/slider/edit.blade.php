    ...
    <form id="form_validation" action="{{route('slider.update',['slider' => $slider->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-6">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input name="header" type="text" required class="form-control" value="{{$slider->header}}">
            ...
            <div class="col-sm-6">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input name="description" type="text" required class="form-control" value="{{$slider->description}}">
            ...
            <div class="col-sm-6">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input name="country" type="text" required class="form-control" value="{{$slider->country}}">
    ...
    <div class="col-sm-6">
        <div class="form-group form-float">
            <div class="form-line">
                ...
                <input name="slider_id" type="hidden"   class="form-control " value="{{$slider->id}}" >
